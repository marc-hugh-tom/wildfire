...
onready var on_fire_start_texture = preload("res://assets/dry_trees_fire_start.png")
onready var on_fire_spread_texture = preload("res://assets/dry_trees_fire_full.png")
